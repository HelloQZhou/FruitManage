...
public class FruitDAOImpl extends BaseDAO<Fruit> implements FruitDAO {
  ...
  @Override
    ...
    public int getFruitCount(String keyword) {
        //executeComplexQuery 返回的是 Object 数组
        //return (Integer) super.executeComplexQuery("select count(*) from t_fruit" )[0]; //java: 不兼容的类型: java.lang.Long无法转换为int
        //应转为 long 后面加方法 .intValue()
